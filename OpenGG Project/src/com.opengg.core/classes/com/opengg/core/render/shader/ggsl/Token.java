...
public enum Token {
    ...
    OPEN_BRACKET (Pattern.quote("["), true, "["),
    CLOSE_BRACKET (Pattern.quote("]"), true, "]"),
    ...
    MULTIPLY (Pattern.quote("*"), true, "*"),
    DIVIDE (Pattern.quote("/"), true, "/"),
    ...
    FLOAT_LITERAL ("\\s(?<![.a-zA-Z])\\d+\\.?\\d*f?\\s", false),
